        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center mb-4">
              <img src="/vendorsoluce.png" alt="VendorSoluce" className="h-8 w-auto mr-3" />
              <span className="text-xl font-bold">VendorSoluce</span>
            </div>
            <p className="text-gray-300 mb-4">
              Comprehensive supply chain risk management platform for modern organizations. 
              Secure your supply chain with NIST-aligned assessments and automated compliance tools.
            </p>
            <div className="space-y-2 text-sm text-gray-400">
              <div className="flex items-center">
                <Mail className="h-4 w-4 mr-2" />
                <span>contact@vendorsoluce.com</span>
              </div>
              <div className="flex items-center">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm">
              © 2025 VendorSoluce. All rights reserved.
            </div>
